...
build-kernel:
	...
	$(GCC) src/libs/extras/vga.c -o build/vga.o -m32 -nostdlib -nostdinc -fno-builtin -fno-stack-protector -nostartfiles -nodefaultlibs -Wall -Wextra -Werror -c
	...
	$(GCC) src/libs/io/io.c -o build/io.o -m32 -nostdlib -nostdinc -fno-builtin -fno-stack-protector -nostartfiles -nodefaultlibs -Wall -Wextra -Werror -c
	$(GCC) src/libs/standard/cursor.c -o build/cursor.o -m32 -nostdlib -nostdinc -fno-builtin -fno-stack-protector -nostartfiles -nodefaultlibs -Wall -Wextra -Werror -c
	$(LD) -T src/link.ld -melf_i386 build/grub-boot.o build/print.o build/string.o build/vga.o build/aui.o build/io.o build/cursor.o build/kernel.o build/kernel_ep.o -o build/kernel.elf
build-isofs:
